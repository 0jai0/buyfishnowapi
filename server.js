...
const notificationRoutes = require("./routes/admin/notifications-routes");
...
const messageRouter = require("./routes/shop/message-routes"); 
...
app.use("/api/shop/update", messageRouter);
